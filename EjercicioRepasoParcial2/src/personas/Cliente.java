...
public class Cliente extends Persona implements Subscriber {
    ...
    public int getCompanions() {return companions;}
    public void setCompanions(int companions) {this.companions = companions;}
    ...
    public void setReservas(Vector<Reserva> reservas) {this.reservas = reservas;}

    @Override
    public void update(String msg) {
        // Aquí se utiliza el mensaje para enviar un correo al cliente
